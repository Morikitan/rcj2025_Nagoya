...
CMakeFiles\picotoolBuild-complete: picotool\src\picotoolBuild-stamp\picotoolBuild-test
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=C:\Pico\test\build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Completed 'picotoolBuild'"
	echo >nul && "C:\Program Files\CMake\bin\cmake.exe" -E make_directory C:/Pico/test/build/CMakeFiles
	echo >nul && "C:\Program Files\CMake\bin\cmake.exe" -E touch C:/Pico/test/build/CMakeFiles/picotoolBuild-complete
	echo >nul && "C:\Program Files\CMake\bin\cmake.exe" -E touch C:/Pico/test/build/picotool/src/picotoolBuild-stamp/picotoolBuild-done
...
picotool\src\picotoolBuild-stamp\picotoolBuild-build: picotool\src\picotoolBuild-stamp\picotoolBuild-configure
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=C:\Pico\test\build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Performing build step for 'picotoolBuild'"
...
picotool\src\picotoolBuild-stamp\picotoolBuild-configure: picotool\src\picotoolBuild-stamp\picotoolBuild-patch
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=C:\Pico\test\build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Performing configure step for 'picotoolBuild'"
	cd C:\Pico\test\build\_deps\picotool-build
	echo >nul && "C:\Program Files\CMake\bin\cmake.exe" --no-warn-unused-cli -DCMAKE_MAKE_PROGRAM:FILEPATH=nmake -DPICO_SDK_PATH:FILEPATH=C:/Pico/pico-sdk -DPICOTOOL_NO_LIBUSB=1 -DPICOTOOL_FLAT_INSTALL=1 -DCMAKE_INSTALL_PREFIX=C:/Pico/test/build/_deps -DCMAKE_RULE_MESSAGES=OFF -DCMAKE_INSTALL_MESSAGE=NEVER "-GNMake Makefiles" -S C:/Pico/test/build/_deps/picotool-src -B C:/Pico/test/build/_deps/picotool-build
	echo >nul && "C:\Program Files\CMake\bin\cmake.exe" -E touch C:/Pico/test/build/picotool/src/picotoolBuild-stamp/picotoolBuild-configure
	cd C:\Pico\test\build
...
picotool\src\picotoolBuild-stamp\picotoolBuild-download: picotool\src\picotoolBuild-stamp\picotoolBuild-mkdir
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=C:\Pico\test\build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "No download step for 'picotoolBuild'"
	echo >nul && "C:\Program Files\CMake\bin\cmake.exe" -E echo_append
	echo >nul && "C:\Program Files\CMake\bin\cmake.exe" -E touch C:/Pico/test/build/picotool/src/picotoolBuild-stamp/picotoolBuild-download

picotool\src\picotoolBuild-stamp\picotoolBuild-install: picotool\src\picotoolBuild-stamp\picotoolBuild-build
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=C:\Pico\test\build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "Performing install step for 'picotoolBuild'"
	cd C:\Pico\test\build\_deps\picotool-build
	$(MAKE) install
	cd C:\Pico\test\build
...
picotool\src\picotoolBuild-stamp\picotoolBuild-mkdir:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=C:\Pico\test\build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_6) "Creating directories for 'picotoolBuild'"
	echo >nul && "C:\Program Files\CMake\bin\cmake.exe" -Dcfgdir= -P C:/Pico/test/build/picotool/tmp/picotoolBuild-mkdirs.cmake
	echo >nul && "C:\Program Files\CMake\bin\cmake.exe" -E touch C:/Pico/test/build/picotool/src/picotoolBuild-stamp/picotoolBuild-mkdir
...
picotool\src\picotoolBuild-stamp\picotoolBuild-patch: picotool\src\picotoolBuild-stamp\picotoolBuild-update
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=C:\Pico\test\build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_7) "No patch step for 'picotoolBuild'"
	echo >nul && "C:\Program Files\CMake\bin\cmake.exe" -E echo_append
	echo >nul && "C:\Program Files\CMake\bin\cmake.exe" -E touch C:/Pico/test/build/picotool/src/picotoolBuild-stamp/picotoolBuild-patch

picotool\src\picotoolBuild-stamp\picotoolBuild-test: picotool\src\picotoolBuild-stamp\picotoolBuild-install
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=C:\Pico\test\build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_8) "Performing test step for 'picotoolBuild'"
	cd C:\Pico\test\build\_deps\picotool-build
	C:\Pico\test\build\_deps\picotool\picotool version 2.1.0
	echo >nul && "C:\Program Files\CMake\bin\cmake.exe" -E touch C:/Pico/test/build/picotool/src/picotoolBuild-stamp/picotoolBuild-test
	cd C:\Pico\test\build
...
picotool\src\picotoolBuild-stamp\picotoolBuild-update: picotool\src\picotoolBuild-stamp\picotoolBuild-download
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=C:\Pico\test\build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_9) "No update step for 'picotoolBuild'"
	echo >nul && "C:\Program Files\CMake\bin\cmake.exe" -E echo_append
	echo >nul && "C:\Program Files\CMake\bin\cmake.exe" -E touch C:/Pico/test/build/picotool/src/picotoolBuild-stamp/picotoolBuild-update
...
CMakeFiles\picotoolBuild.dir\depend:
	$(CMAKE_COMMAND) -E cmake_depends "NMake Makefiles" C:\Pico\test C:\Pico\test C:\Pico\test\build C:\Pico\test\build C:\Pico\test\build\CMakeFiles\picotoolBuild.dir\DependInfo.cmake "--color=$(COLOR)"
